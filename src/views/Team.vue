  ...
  <div class="cards">
    <transition appear appear-active-class="animated flipInX">
      <a class="card card-1" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        <img class="card-header" src="@/assets/slack.png" :class="{'light-header': !isDarkMode, 'dark-header' :isDarkMode}">
    ...
    <transition appear appear-active-class="animated flipInX">
      <a class="card card-2" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        <img class="card-header" src="@/assets/notion.png" :class="{'light-header': !isDarkMode, 'dark-header' :isDarkMode}">
    ...
    <transition appear appear-active-class="animated flipInX">
      <a class="card card-3" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        <img class="card-header" src="@/assets/figma.png" :class="{'light-header': !isDarkMode, 'dark-header' :isDarkMode}">
    ...
    <transition appear appear-active-class="animated flipInX">
      <a class="card card-4" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        <img class="card-header" src="@/assets/dropbox.png" :class="{'light-header': !isDarkMode, 'dark-header' :isDarkMode}">
    ...
    <transition appear appear-active-class="animated flipInX">
      <a class="card card-5" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        <img class="card-header" src="@/assets/contentful.png" :class="{'light-header': !isDarkMode, 'dark-header' :isDarkMode}">
